    ...
    <section>
        <div className="container py-3">
            <div className="Scontainer">
                ...
                <div className="postV">
                <FontAwesomeIcon className="ic" icon={faEye} size="xs" style={{marginLeft: "35px", marginTop: "5px"}}/>
                    <span className="sv" style={{marginLeft: "5px"}}>563 views</span>
                </div>
                <h3>Should I Buy a New Car or Lease a New Car in 2021?</h3>
                <p>We provide a full range of front end mechanical repairs for all makes and models of cars, no matter the cause. This includes We provide a full range of front end mechanical. All models of cars, no matter the cause. This includes We provide a full range of front end mechanical.</p>
            </div>
            <img src={pic1} id="pic-1"  />
        </div>
        ...
        <div className="container">
            <div className="Scontainer">
                <h4 style={{marginTop: "30px"}}>This is a small blog post headline</h4>
